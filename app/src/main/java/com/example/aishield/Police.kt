...
class Police : AppCompatActivity() {
    ...
    private val REQ_CODE_TITLE = 201
    private val REQ_CODE_DESC = 202
    private val REQ_CODE_LOC = 203
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Firebase reference
        database = FirebaseDatabase.getInstance().getReference("PoliceComplaints")

        // Find views
        etTitle = findViewById(R.id.etComplaintTitle)
        etDescription = findViewById(R.id.etComplaintDescription)
        etLocation = findViewById(R.id.etComplaintLocation)
            ...
            if (title.isNotEmpty() && description.isNotEmpty() && location.isNotEmpty()) {
                ...
                database.child(complaintId).setValue(complaint)
                    .addOnSuccessListener {
                        Toast.makeText(this, "Police complaint submitted ✅", Toast.LENGTH_SHORT).show()
                        etTitle.text.clear()
                ...
                Toast.makeText(this, "Please fill all fields ⚠️", Toast.LENGTH_SHORT).show()
            }
        }
    }

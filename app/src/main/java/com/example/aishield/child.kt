...
class child : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        database = FirebaseDatabase.getInstance().getReference("ChildComplaints")

        // Views
        etTitle = findViewById(R.id.etChildComplaintTitle)
        etDescription = findViewById(R.id.etChildComplaintDescription)
        etLocation = findViewById(R.id.etChildComplaintLocation)
        val btnSubmit = findViewById<Button>(R.id.btnChildSubmit)
        ...
        tts = TextToSpeech(this) { status ->
            if (status == TextToSpeech.SUCCESS) {
                ...
                speak("You can speak your complaint details now.")
            }
        }
        ...
        btnSubmit.setOnClickListener {
            ...
            if (title.isNotEmpty() && desc.isNotEmpty() && loc.isNotEmpty()) {
                ...
                val complaint = ChildComplaint(title, desc, loc)
    ...
    /** Start voice recognition and insert text into EditText */
